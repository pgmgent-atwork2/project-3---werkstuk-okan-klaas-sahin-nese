...
describe('API test', () => {
  ...
  describe('Testing HTTP methods', () => {
    ...
    test('POST - /api/student', async () => {
      ...
      const response = await request(app).post('/api/student').send(student);
    ...
    test('PUT - /api/student', async () => {
      ...
      const response = await request(app).put('/api/student').send(student);
    ...
    test('POST - /api/staf', async () => {
      ...
      const response = await request(app).post('/api/staf').send(staf);
      // controleren op statuscode
      expect(response.statusCode).toBe(201);
      expect(response.body).toHaveProperty('id');
    });
    ...
    test('PUT - /api/staf', async () => {
      ...
      const response = await request(app).put('/api/staf').send(staf);
      expect(response.status).toBe(201);
    });
    ...
    test('POST - /api/oefeningen', async () => {
      ...
      const response = await request(app).post('/api/oefeningen').send(oef);
      // controleren op statuscode
      expect(response.statusCode).toBe(201);
      expect(response.body).toHaveProperty('id');
    });
    ...
    test('PUT - /api/oefeningen', async () => {
      ...
      const response = await request(app).put('/api/oefeningen').send(oef);
      expect(response.status).toBe(201);
    });
    ...
    test('POST - /api/commands', async () => {
      ...
      const response = await request(app).post('/api/commands').send(command);
      // controleren op statuscode
      expect(response.statusCode).toBe(201);
      expect(response.body).toHaveProperty('id');
    });
    ...
    test('POST - /api/klassen', async () => {
      ...
      const response = await request(app).post('/api/klassen').send(klas);
      // controleren op statuscode
      expect(response.statusCode).toBe(201);
      expect(response.body).toHaveProperty('id');
    });
    ...
    test('PUT - /api/klassen', async () => {
      ...
      const response = await request(app).put('/api/klassen').send(klas);
      expect(response.status).toBe(201);
    });
    ...
    test('POST - /api/vakken', async () => {
      ...
      const response = await request(app).post('/api/vakken').send(vak);
      // controleren op statuscode
      expect(response.statusCode).toBe(201);
      expect(response.body).toHaveProperty('id');
    });
    ...
    test('PUT - /api/vakken', async () => {
      ...
      const response = await request(app).put('/api/vakken').send(vak);
      expect(response.status).toBe(201);
    });
  });
});
